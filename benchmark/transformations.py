...
def spherical_to_complex(theta, phi):
    ...
    This uses :meth:`benchmark.transformations.spherical_riemann_to_complex`, however provides maintains the shape of the input tensor and output tensor.
...
def complex_to_spherical(s):
    ...
    This uses :meth:`benchmark.transformations.complex_to_spherical_riemann`, however provides maintains the shape of the input tensor and output tensor.
